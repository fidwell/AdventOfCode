...
public class SolutionVerifier2016() : SolutionVerifier(2016)
{
    ...
    public void Solve_2016_01(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_02(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_03(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_04(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_05(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_06(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_07(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_08(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_09(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_10(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_11(int part, bool useExample, object expected) =>
    ...
    public void Solve_2016_12(int part, bool useExample, object expected) =>
        Solve(new Puzzle12Solver(), 12, part, useExample, expected);

    [DataTestMethod, Timeout(Timeout)]
    [DataRow(1, true, 11, DisplayName = "2016.13.1-example")]
    [DataRow(1, false, 90, DisplayName = "2016.13.1-problem")]
    [DataRow(2, false, 135, DisplayName = "2016.13.2-problem")]
    public void Solve_2016_13(int part, bool useExample, object expected) =>
        Solve(new Puzzle13Solver(), 13, part, useExample, expected);

    [DataTestMethod]
    [DataRow(1, true, 22728, DisplayName = "2016.14.1-example")]
    [DataRow(1, false, 16106, DisplayName = "2016.14.1-problem")]
    [DataRow(2, true, 22551, DisplayName = "2016.14.2-example")]
